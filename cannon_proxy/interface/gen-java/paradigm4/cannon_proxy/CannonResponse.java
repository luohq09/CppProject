...
public class CannonResponse implements org.apache.thrift.TBase<CannonResponse, CannonResponse._Fields>, java.io.Serializable, Cloneable, Comparable<CannonResponse> {
  ...
  public List<ValueItem> values; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.VALUES, new org.apache.thrift.meta_data.FieldMetaData("values", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ValueItem.class))));
  ...
  public CannonResponse(CannonResponse other) {
    ...
    if (other.isSetValues()) {
      List<ValueItem> __this__values = new ArrayList<ValueItem>(other.values.size());
      for (ValueItem other_element : other.values) {
        __this__values.add(new ValueItem(other_element));
      }
  ...
  public java.util.Iterator<ValueItem> getValuesIterator() {
    return (this.values == null) ? null : this.values.iterator();
  }

  public void addToValues(ValueItem elem) {
    if (this.values == null) {
      this.values = new ArrayList<ValueItem>();
    }
  ...
  public CannonResponse setValues(List<ValueItem> values) {
    this.values = values;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VALUES:
      if (value == null) {
        ...
        setValues((List<ValueItem>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status = paradigm4.cannon_proxy.Status.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.values = new ArrayList<ValueItem>(_list8.size);
                ValueItem _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new ValueItem();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CannonResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (ValueItem _iter11 : struct.values)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetValues()) {
        {
          ...
          for (ValueItem _iter12 : struct.values)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.values = new ArrayList<ValueItem>(_list13.size);
          ValueItem _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new ValueItem();
            _elem14.read(iprot);
